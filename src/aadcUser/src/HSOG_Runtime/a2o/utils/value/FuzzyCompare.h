...
public:
  ...
  template<typename T>
  static bool eq(const T& lhs, const T& rhs, const T& range);
  
  /** Check: lhs >= rhs - range */
  template<typename T>
  static bool gte(const T& lhs, const T& rhs, const T& range);
  
  /** Check: lhs <= rhs + range */
  template<typename T>
  static bool lte(const T& lhs, const T& rhs, const T& range);
  ...
  static double getLinearFuzzyValue(double x0, double x1,
  		bool ascending, double x);

  static double linearInterpolation(double x0, double y0, double x1,
  			double y1, double x);
