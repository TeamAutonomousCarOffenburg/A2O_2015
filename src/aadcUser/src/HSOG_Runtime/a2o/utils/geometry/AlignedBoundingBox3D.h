...
public:
  ...
  AlignedBoundingBox3D(const Eigen::Vector3d& origin, const Eigen::Vector3d& minPoint, const Eigen::Vector3d& maxPoint);
  AlignedBoundingBox3D(const Eigen::Vector3d& origin, const Eigen::Vector3d& minPoint, const Eigen::Vector3d& maxPoint, uint score);
