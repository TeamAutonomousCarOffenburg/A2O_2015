...
Pose2D::Pose2D()
      : _position(0, 0), _angle(0)
{
}

Pose2D::Pose2D(const Pose2D& other)
      : _position(other._position), _angle(other._angle)
{
}

Pose2D::Pose2D(const Vector2d& position)
      : _position(position), _angle(0)
{
}

Pose2D::Pose2D(const double& x, const double& y)
      : _position(x, y), _angle()
{
}

Pose2D::Pose2D(const Angle& angle)
      : _position(0, 0), _angle(angle)
{
}

Pose2D::Pose2D(const Vector2d& position, const Angle& angle)
      : _position(position), _angle(angle)
{
}

Pose2D::Pose2D(const double& x, const double& y, const Angle& angle)
      : _position(x, y), _angle(angle)
{
}
