...
public:
  ...
  bool eq(const Angle& rhs,
	  const Angle& range = Angle::Epsilon()) const;
	  
  /** Fuzzy version of "this >= rhs". */
  bool gte(const Angle& rhs,
	   const Angle& range = Angle::Epsilon()) const;
	   
  /** Fuzzy version of "this <= rhs". */
  bool lte(const Angle& rhs,
	   const Angle& range = Angle::Epsilon()) const;
  ...
  const double getDifferenceTo(const Angle& other,
			       const bool& clockwise = false) const;
...
//   friend std::ostream& operator<<(std::ostream& os, const Angle& angle);
  ...
  static const Angle average(const Angle& a1,
			     const Angle& a2,
			     const double& weight1 = 1,
			     const double& weight2 = 1);
  
  static const Angle average(const std::vector<Angle>& angles);
  
  static const Angle interpolate(const Angle& startAngle,
