...
const double Angle::getDifferenceTo(const Angle& other,
...
const Angle Angle::average(const Angle& a1,
			   const Angle& a2,
...
const Angle Angle::interpolate(const Angle& startAngle,
...
namespace A2O {
	std::ostream& operator<<(std::ostream& os, const A2O::Angle& angle)
	{
