...
public:
   ...
   */
  static pcl::PointCloud<pcl::PointXYZ>::Ptr downSample(pcl::PointCloud<pcl::PointXYZ>::Ptr& pointCloud, float leafSize)
  {
   ...
   */
  static pcl::PointCloud<pcl::PointXYZ>::Ptr extractFloor(pcl::PointCloud<pcl::PointXYZ>::Ptr& pointCloud, bool negative)
  {
   ...
   */
  static std::vector <pcl::PointIndices> segmentation(pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud, double minClusterSize, double numberOfNeighbours)
  {
