...
public:
  CarMetaModel(const double& floorHeight,
  ...
  virtual const std::vector<IDistanceSensorConfig::ConstPtr>& getUltraSoundConfigs() const;
...
protected:
  ...
  std::vector<IDistanceSensorConfig::ConstPtr> _ultraSoundConfigs;
