...
DistanceSensorConfig::DistanceSensorConfig(const std::string& name,
...
DistanceSensorConfig::DistanceSensorConfig(const std::string& name,
					   ...
					   const double& maxDistance,
					   const double& scanWidth)
      : SensorConfig(name, name, position, orientation), _minDistance(minDistance), _maxDistance(maxDistance), _scanWidth(scanWidth)
{
}
